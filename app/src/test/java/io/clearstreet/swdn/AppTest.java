...
class AppTest {
    ...
    void singleTradePnl() {
        ...
        Assertions.assertEquals(trade1.quantity(), positions.getFirst().quantity(), DELTA);
        Assertions.assertEquals(trade1.quantity() * trade1.price(), positions.getFirst().initialValue(),
                DELTA);
    }
    ...
    void twoTradesSameMemberPnl() {
        ...
        Assertions.assertEquals(1, positions.size());
        Assertions.assertEquals(100.0, positions.getFirst().quantity(), DELTA);
        Assertions.assertEquals(9850.0, positions.getFirst().initialValue(),
                DELTA);
    }
    ...
    void recoveryTest() {
        ...
        Assertions.assertEquals(1, positions.size());
        Assertions.assertEquals(quantity, positions.getFirst().quantity(), DELTA);
        Assertions.assertEquals(quantity * price, positions.getFirst().initialValue(),
                DELTA);
    }
